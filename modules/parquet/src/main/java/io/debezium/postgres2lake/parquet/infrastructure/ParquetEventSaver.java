...
public class ParquetEventSaver extends AbstractEventSaver<ParquetEventAppender> {
    private static final Logger logger = Logger.getLogger(ParquetEventSaver.class);
