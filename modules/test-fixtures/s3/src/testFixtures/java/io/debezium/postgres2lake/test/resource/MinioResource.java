    ...
    public Map<String, String> start() {
        ...
        switch (format) {
            ...
            case "iceberg" -> {
                ...
                properties.put("debezium.output.iceberg.properties.s3.client-factory-impl", "io.debezium.postgres2lake.iceberg.infrastructure.InstrumentedS3FileIOAwsClientFactory");
            }
            case "iceberg-hadoop" -> {
