...
## Docker image publishing (CD)

GitHub Actions workflow `.github/workflows/publish-images.yaml` publishes Docker images to Docker Hub for:

- `debezium-postgres2lake-avro`
- `debezium-postgres2lake-orc`
- `debezium-postgres2lake-parquet`
- `debezium-postgres2lake-paimon`
- `debezium-postgres2lake-iceberg`
