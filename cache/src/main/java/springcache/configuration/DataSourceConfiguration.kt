...
@EnableJpaRepositories(basePackages = arrayOf("springcache.model.repositories"))
@ComponentScan(basePackages = arrayOf("springcache.model"))
open class DataSourceConfiguration : Serializable {
    ...
    open fun entityManagerFactory(): LocalContainerEntityManagerFactoryBean {
        ...
        entityManagerFactory.apply {
            ...
            setPackagesToScan("springcache.model")
