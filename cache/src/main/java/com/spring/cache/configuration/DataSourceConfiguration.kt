package com.spring.cache.configuration
...
@EnableJpaRepositories(basePackages = arrayOf("com.spring.cache.model.repositories"))
@ComponentScan(basePackages = arrayOf("com.spring.cache.model"))
open class DataSourceConfiguration : Serializable {
    ...
    open fun entityManagerFactory(): LocalContainerEntityManagerFactoryBean {
        ...
        entityManagerFactory.apply {
            ...
            setPackagesToScan("com.spring.cache.model")
