...
@EnableJpaRepositories(basePackages = arrayOf("com.hibernate.cache.model.repositories"))
@ComponentScan(basePackages = arrayOf("com.hibernate.cache.model"))
open class DataSourceConfiguration : Serializable {
    ...
    open fun entityManagerFactory(): LocalContainerEntityManagerFactoryBean {
        ...
        entityManagerFactory.apply {
            ...
            setPackagesToScan("com.hibernate.cache.model")
